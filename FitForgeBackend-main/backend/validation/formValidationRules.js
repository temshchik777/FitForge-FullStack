...
const formValidationRules = [
  ...
  },
  {
    ...
    method: "matches",
    validWhen: true,
    args: [/^[a-zA-Zа-яА-ЯІіЇїЄєҐґ]+$/],
    message: "Allowed characters for First Name is a-z, A-Z, а-я, А-Я, І, Ї, Є, Ґ."
  },
  {
    field: "firstName",
    method: "isLength",
  ...
  },
  {
    ...
    validWhen: true,
    args: [/^[a-zA-Zа-яА-ЯІіЇїЄєҐґ]+$/],
    message: "Allowed characters for Last Name is a-z, A-Z, а-я, А-Я, І, Ї, Є, Ґ."
  },
  {
    field: "lastName",
    method: "isLength",
